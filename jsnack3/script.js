...
console.log('Il secondo array é: ' + array2);
  ...
  if(lunghezzaArray1 > lunghezzaArray2)
  {
    ...
    console.log("Dopo l'aggiunta di elementi al secondo array, i due array hanno la stessa quantità di elementi" );
    ...
    console.log("Dopo l'aggiunta di elementi al primo array, i due array hanno la stessa quantità di elementi" );
    console.log('Array 1 risulta: ' + array1);
    console.log('Array 2 risulta: ' + array2);
